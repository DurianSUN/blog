...
!function (e, n, t) {
    ...
    function i() {
        ...
        for (var f in C)if (C.hasOwnProperty(f)) {
            ...
            for (i = r(n.fn, "function") ? n.fn() : n.fn, o = 0; o < e.length; o++)s = e[o], a = s.split("."), 1 === a.length ? Modernizr[a[0]] = i : (!Modernizr[a[0]] || Modernizr[a[0]]instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = i), g.push((i ? "" : "no-") + a.join("-"))
        }
    }
    ...
    function c(e, t, r, i) {
        var o, s, f, l, u = "modernizr", p = a("div"), c = d();
        if (parseInt(r, 10))for (; r--;)f = a("div"), f.id = i ? i[r] : u + (r + 1), p.appendChild(f);
    ...
    function m(n, r) {
        ...
        if ("CSS"in e && "supports"in e.CSS) {
            for (; i--;)if (e.CSS.supports(s(n[i]), r))return !0;
            return !1
        }
        if ("CSSSupportsRule"in e) {
            for (var o = []; i--;)o.push("(" + s(n[i]) + ":" + r + ")");
    ...
    function v(e, n, i, o) {
        ...
        for (var p, d, c, v, h, y = ["modernizr", "tspan"]; !T.style;)p = !0, T.modElem = a(y.shift()), T.style = T.modElem.style;
        for (c = e.length, d = 0; c > d; d++)if (v = e[d], h = T.style[v], l(v, "-") && (v = f(v)), T.style[v] !== t) {
            if (o || r(i, "undefined"))return s(), "pfx" == n ? v : !0;
            try {
                T.style[v] = i
            } catch (g) {
            }
            if (T.style[v] != h)return s(), "pfx" == n ? v : !0
        }
        return s(), !1
    }
    ...
    function h(e, n, t, i, o) {
        ...
        return r(n, "string") || r(n, "undefined") ? v(a, n, i, o) : (a = (e + " " + b.join(s + " ") + s).split(" "), p(a, n, t))
    }
    ...
    var S = n.documentElement, _ = "svg" === S.nodeName.toLowerCase(), w = "Moz O ms Webkit", b = x._config.usePrefixes ? w.toLowerCase().split(" ") : [];
    x._domPrefixes = b;
    var E = function (e, n) {
        var t = !1, r = a("div"), i = r.style;
        if (e in i) {
            var o = b.length;
            for (i[e] = n, t = i[e]; o-- && !t;)i[e] = "-" + b[o] + "-" + n, t = i[e]
        }
        return "" === t && (t = !1), t
    };
    x.prefixedCSSValue = E;
    var N = x._config.usePrefixes ? w.split(" ") : [];
    x._cssomPrefixes = N;
    var P = function (n) {
    ...
    var T = {style: z.elem.style};
    Modernizr._q.unshift(function () {
        delete T.style
    }), x.testAllProps = h, x.testAllProps = y, Modernizr.addTest("cssanimations", y("animationName", "a", !0));
    var j = x.prefixed = function (e, n, t) {
        return 0 === e.indexOf("@") ? P(e) : (-1 != e.indexOf("-") && (e = f(e)), n ? h(e, n, t) : h(e, "pfx"))
    };
    x.prefixedCSS = function (e) {
        var n = j(e);
        return n && s(n)
    };
    i(), o(g), delete x.addTest, delete x.addAsyncTest;
