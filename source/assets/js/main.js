!function (e, t) {
    ...
    function x(e) {
        var t = Q, n = Ie[e];
        return n || (n = b(e, t), "none" !== n && n || (Be = (Be || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Be[0].contentDocument, t.write(), t.close(), n = b(e, t), Be.detach()), Ie[e] = n), n
    }

    function w(e, t, n) {
        var i, r, o, s, a = e.style;
        return n = n || $e(e), n && (s = n.getPropertyValue(t) || n[t]), n && ("" !== s || Z.contains(e.ownerDocument, e) || (s = Z.style(e, t)), ze.test(s) && We.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function E(e, t, n) {
        var i = !0, r = "width" === t ? e.offsetWidth : e.offsetHeight, o = $e(e), s = "border-box" === Z.css(e, "boxSizing", !1, o);
        if (0 >= r || null == r) {
            if (r = w(e, t, o), (0 > r || null == r) && (r = e.style[t]), ze.test(r))return r;
    ...
    function N(e, t) {
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++)i = e[s], i.style && (o[s] = ve.get(i, "olddisplay"), n = i.style.display, t ? (o[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ce(i) && (o[s] = ve.access(i, "olddisplay", x(i.nodeName)))) : (r = Ce(i), "none" === n && r || ve.set(i, "olddisplay", r ? n : Z.css(i, "display"))));
    ...
    function O(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height"in t || "width"in t) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], l = Z.css(e, "display"), c = "none" === l ? ve.get(e, "olddisplay") || x(e.nodeName) : l, "inline" === c && "none" === Z.css(e, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", d.always(function () {
        ...
        if (Z.isEmptyObject(p))"inline" === ("none" === l ? x(e.nodeName) : l) && (f.display = l); else {
    ...
    function M(e, t, n) {
        var i, r, o = 0, s = tt.length, a = Z.Deferred().always(function () {
            ...
            if (r)return !1;
            for (var t = Ge || D(), n = Math.max(0, l.startTime + l.duration - t), i = n / l.duration || 0, o = 1 - i, s = 0, u = l.tweens.length; u > s; s++)l.tweens[s].run(o);
        ...
        for (q(c, l.opts.specialEasing); s > o; o++)if (i = tt[o].call(l, e, c, l.opts))return i;
    ...
    function I(e, t, n, i) {
        ...
        }); else if (n || "object" !== Z.type(t))i(e, t); else for (r in t)I(e + "[" + r + "]", t[r], n, i)
    }
    ...
    var z = [], $ = z.slice, _ = z.concat, X = z.push, V = z.indexOf, U = {}, J = U.toString, Y = U.hasOwnProperty, G = {}, Q = e.document, K = "2.1.4", Z = function (e, t) {
    ...
    Z.fn = Z.prototype = {
        ...
        expando: "jQuery" + (K + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var n, i, r;
            return "string" == typeof t && (n = e[t], t = e, e = n), Z.isFunction(e) ? (i = $.call(arguments, 2), r = function () {
    ...
    var re = function (e) {
        function t(e, t, n, i) {
            ...
            if ((t ? t.ownerDocument || t : I) !== O && L(t), t = t || O, n = n || [], a = t.nodeType, "string" != typeof e || !e || 1 !== a && 9 !== a && 11 !== a)return n;
            if (!i && M) {
                ...
                if (w.qsa && (!H || !H.test(e))) {
                    if (f = d = B, h = t, g = 1 !== a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
                        for (l = k(e), (d = t.getAttribute("id")) ? f = d.replace(xe, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", u = l.length; u--;)l[u] = f + p(l[u]);
        ...
        function f(e, t, n) {
            ...
            return t.first ? function (t, n, o) {
                ...
                if (s) {
                    ...
                    if (u = t[B] || (t[B] = {}), (a = u[i]) && a[0] === W && a[1] === o)return l[2] = a[2];
        ...
        function v(e, t, n, r, o, s) {
            return r && !r[B] && (r = v(r)), o && !o[B] && (o = v(o, s)), i(function (i, s, a, u) {
                ...
                if (n && n(y, b, a, u), r)for (l = m(b, f), r(l, [], a, u), c = l.length; c--;)(d = l[c]) && (b[f[c]] = !(y[f[c]] = d));
                if (i) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (c = b.length; c--;)(d = b[c]) && (l = o ? ee(i, d) : p[c]) > -1 && (i[l] = !(s[l] = d))
                    }
        ...
        function y(e) {
            for (var t, n, i, r = e.length, o = T.relative[e[0].type], s = o || T.relative[" "], a = o ? 1 : 0, u = f(function (e) {
                ...
                return t = null, r
            }]; r > a; a++)if (n = T.relative[e[a].type])c = [f(h(c), n)]; else {
                if (n = T.filter[e[a].type].apply(null, e[a].matches), n[B]) {
                    for (i = ++a; r > i && !T.relative[e[i].type]; i++);
                    return v(a > 1 && h(c), a > 1 && p(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(ue, "$1"), n, i > a && y(e.slice(a, i)), r > i && y(e = e.slice(i)), r > i && p(e))
                }
                c.push(n)
            }
            return h(c)
        ...
        function b(e, n) {
            var r = n.length > 0, o = e.length > 0, s = function (i, s, a, u, l) {
                ...
                if (f += h, r && h !== f) {
                    ...
                    if (i) {
                        if (f > 0)for (; h--;)g[h] || v[h] || (v[h] = G.call(u));
                        v = m(v)
                    }
        ...
        w = t.support = {}, S = t.isXML = function (e) {
            ...
            return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, q = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), M = !S(i), w.attributes = r(function (e) {
                ...
                }, P = [], H = [], (w.qsa = ve.test(i.querySelectorAll)) && (r(function (e) {
                ...
                w.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), P.push("!=", se)
            }), H = H.length && new RegExp(H.join("|")), P = P.length && new RegExp(P.join("|")), t = ve.test(q.compareDocumentPosition), R = t || ve.test(q.contains) ? function (e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === i || e.ownerDocument === I && R(I, e) ? -1 : t === i || t.ownerDocument === I && R(I, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t)return A = !0, 0;
            ...
            if ((e.ownerDocument || e) !== O && L(e), n = n.replace(de, "='$1']"), !(!w.matchesSelector || !M || P && P.test(n) || H && H.test(n)))try {
                var i = F.call(e, n);
            ...
            return (e.ownerDocument || e) !== O && L(e), R(e, t)
        }, t.attr = function (e, t) {
            (e.ownerDocument || e) !== O && L(e);
            var n = T.attrHandle[t.toLowerCase()], i = n && J.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !M) : void 0;
                    ...
                    return 1 === i && 0 === r ? function (e) {
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (c = m[B] || (m[B] = {}), l = c[e] || [], f = l[0] === W && l[1], p = l[0] === W && l[2], d = f && m.childNodes[f]; d = ++f && d && d[g] || (p = f = 0) || h.pop();)if (1 === d.nodeType && ++p && d === t) {
                                    c[e] = [W, f, p];
                                    break
                                }
                            } else if (y && (l = (t[B] || (t[B] = {}))[e]) && l[0] === W)p = l[1]; else for (; (d = ++f && d && d[g] || (p = f = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++p || (y && ((d[B] || (d[B] = {}))[e] = [W, p]), d !== t)););
        ...
        return d.prototype = T.filters = T.pseudos, T.setFilters = new d, k = t.tokenize = function (e, n) {
            ...
            var n, i = [], r = [], o = X[e + " "];
            if (!o) {
                for (t || (t = k(e)), n = t.length; n--;)o = y(t[n]), o[B] ? i.push(o) : r.push(o);
            ...
            if (n = n || [], 1 === d.length) {
                if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && w.getById && 9 === t.nodeType && M && T.relative[o[1].type]) {
                    if (t = (T.find.ID(s.matches[0].replace(we, Te), t) || [])[0], !t)return n;
                    l && (t = t.parentNode), e = e.slice(o.shift().value.length)
                }
                for (r = he.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !T.relative[a = s.type]);)if ((u = T.find[a]) && (i = u(s.matches[0].replace(we, Te), be.test(o[0].type) && c(t.parentNode) || t))) {
                    if (o.splice(r, 1), e = i.length && p(o), !e)return K.apply(n, i), n;
                    break
                }
            }
            return (l || E(e, d))(i, t, !M, n, be.test(e) && c(t.parentNode) || t), n
        }, w.sortStable = B.split("").sort(V).join("") === B, w.detectDuplicates = !!A, L(), w.sortDetached = r(function (e) {
    ...
    var ue, le = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ce = Z.fn.init = function (e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (n[1]) {
                if (t = t instanceof Z ? t[0] : t, Z.merge(this, Z.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : Q, !0)), se.test(n[1]) && Z.isPlainObject(t))for (n in t)Z.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                return this
            }
    ...
    Z.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, i, r = 0, o = $.call(arguments), s = o.length, a = 1 !== s || e && Z.isFunction(e.promise) ? s : 0, u = 1 === a ? e : Z.Deferred(), l = function (e, n, i) {
                return function (r) {
                    n[e] = this, i[e] = arguments.length > 1 ? $.call(arguments) : r, i === t ? u.notifyWith(n, i) : --a || u.resolveWith(n, i)
                }
            };
    ...
    var Ee = /^key/, Ne = /^(?:mouse|pointer|contextmenu)|click/, je = /^(?:focusinfocus|focusoutblur)$/, De = /^([^.]*)(?:\.(.+)|)$/;
    Z.event = {
        global: {},
        add: function (e, t, n, i, r) {
            var o, s, a, u, l, c, d, p, f, h, g, m = ve.get(e);
            if (m)for (n.handler && (o = n, n = o.handler, r = o.selector), n.guid || (n.guid = Z.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
                return typeof Z !== ke && Z.event.triggered !== t.type ? Z.event.dispatch.apply(e, arguments) : void 0
            }), t = (t || "").match(fe) || [""], l = t.length; l--;)a = De.exec(t[l]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (d = Z.event.special[f] || {}, f = (r ? d.delegateType : d.bindType) || f, d = Z.event.special[f] || {}, c = Z.extend({
                type: f,
                origType: g,
                data: i,
                handler: n,
                ...
                namespace: h.join(".")
            }, o), (p = u[f]) || (p = u[f] = [], p.delegateCount = 0, d.setup && d.setup.call(e, i, h, s) !== !1 || e.addEventListener && e.addEventListener(f, s, !1)), d.add && (d.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, c) : p.push(c), Z.event.global[f] = !0)
        },
        remove: function (e, t, n, i, r) {
            var o, s, a, u, l, c, d, p, f, h, g, m = ve.hasData(e) && ve.get(e);
            if (m && (u = m.events)) {
                for (t = (t || "").match(fe) || [""], l = t.length; l--;)if (a = De.exec(t[l]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
                    for (d = Z.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, p = u[f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;)c = p[o], !r && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, d.remove && d.remove.call(e, c));
                    s && !p.length && (d.teardown && d.teardown.call(e, h, m.handle) !== !1 || Z.removeEvent(e, f, m.handle), delete u[f])
        ...
        trigger: function (t, n, i, r) {
            ...
            if (s = a = i = i || Q, 3 !== i.nodeType && 8 !== i.nodeType && !je.test(f + Z.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), l = f.indexOf(":") < 0 && "on" + f, t = t[Z.expando] ? t : new Z.Event(f, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : Z.makeArray(n, [t]), d = Z.event.special[f] || {}, r || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                if (!r && !d.noBubble && !Z.isWindow(i)) {
                    for (u = d.delegateType || f, je.test(u + f) || (s = s.parentNode); s; s = s.parentNode)p.push(s), a = s;
                    a === (i.ownerDocument || Q) && p.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0; (s = p[o++]) && !t.isPropagationStopped();)t.type = o > 1 ? u : d.bindType || f, c = (ve.get(s, "events") || {})[t.type] && ve.get(s, "handle"), c && c.apply(s, n), c = l && s[l], c && c.apply && Z.acceptData(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
                return t.type = f, r || t.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !Z.acceptData(i) || l && Z.isFunction(i[f]) && !Z.isWindow(i) && (a = i[l], a && (i[l] = null), Z.event.triggered = f, i[f](), Z.event.triggered = void 0, a && (i[l] = a)), t.result
            }
        },
        dispatch: function (e) {
            e = Z.event.fix(e);
        ...
        fix: function (e) {
            ...
            for (s || (this.fixHooks[r] = s = Ne.test(r) ? this.mouseHooks : Ee.test(r) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new Z.Event(o), t = i.length; t--;)n = i[t], e[n] = o[n];
    ...
    var Ae = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Le = /<([\w:]+)/, Oe = /<|&#?\w+;/, qe = /<(?:script|style|link)/i, Me = /checked\s*(?:[^=]|=\s*.checked.)/i, He = /^$|\/(?:java|ecma)script/i, Pe = /^true\/(.*)/, Fe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Re = {
    ...
    Re.optgroup = Re.option, Re.tbody = Re.tfoot = Re.colgroup = Re.caption = Re.thead, Re.th = Re.td, Z.extend({
        clone: function (e, t, n) {
            ...
            if (t)if (n)for (o = o || v(e), s = s || v(a), i = 0, r = o.length; r > i; i++)m(o[i], s[i]); else m(e, a);
            return s = v(a, "script"), s.length > 0 && g(s, !u && v(e, "script")), a
        }, buildFragment: function (e, t, n, i) {
            for (var r, o, s, a, u, l, c = t.createDocumentFragment(), d = [], p = 0, f = e.length; f > p; p++)if (r = e[p], r || 0 === r)if ("object" === Z.type(r))Z.merge(d, r.nodeType ? [r] : r); else if (Oe.test(r)) {
                for (o = o || c.appendChild(t.createElement("div")), s = (Le.exec(r) || ["", ""])[1].toLowerCase(), a = Re[s] || Re._default, o.innerHTML = a[1] + r.replace(Ae, "<$1></$2>") + a[2], l = a[0]; l--;)o = o.lastChild;
                Z.merge(d, o.childNodes), o = c.firstChild, o.textContent = ""
            } else d.push(t.createTextNode(r));
            for (c.textContent = "", p = 0; r = d[p++];)if ((!i || -1 === Z.inArray(r, i)) && (u = Z.contains(r.ownerDocument, r), o = v(c.appendChild(r), "script"), u && g(o), n))for (l = 0; r = o[l++];)He.test(r.type || "") && n.push(r);
            return c
        ...
        text: function (e) {
            ...
            if (g || l > 1 && "string" == typeof p && !G.checkClone && Me.test(p))return this.each(function (n) {
                var i = c.eq(n);
            ...
            if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                for (r = Z.map(v(n, "script"), f), o = r.length; l > u; u++)s = n, u !== d && (s = Z.clone(s, !0, !0), o && Z.merge(r, v(s, "script"))), t.call(this[u], s, u);
                if (o)for (a = r[r.length - 1].ownerDocument, Z.map(r, h), u = 0; o > u; u++)s = r[u], He.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Fe, "")))
            }
            return this
        }
    }), Z.each({
    ...
    var _e = /^(none|table(?!-c[ea]).+)/, Xe = new RegExp("^(" + we + ")(.*)$", "i"), Ve = new RegExp("^([+-])=(" + we + ")", "i"), Ue = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Je = {letterSpacing: "0", fontWeight: "400"}, Ye = ["Webkit", "O", "Moz", "ms"];
    Z.extend({
        cssHooks: {
            opacity: {
                get: function (e, t) {
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return t = Z.cssProps[a] || (Z.cssProps[a] = C(u, a)), s = Z.cssHooks[t] || Z.cssHooks[a], void 0 === n ? s && "get"in s && void 0 !== (r = s.get(e, !1, i)) ? r : u[t] : (o = typeof n, "string" === o && (r = Ve.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(Z.css(e, t)), o = "number"), void(null != n && n === n && ("number" !== o || Z.cssNumber[a] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set"in s && void 0 === (n = s.set(e, n, i)) || (u[t] = n))))
            }
        },
        css: function (e, t, n, i) {
            var r, o, s, a = Z.camelCase(t);
            return t = Z.cssProps[a] || (Z.cssProps[a] = C(e.style, a)), s = Z.cssHooks[t] || Z.cssHooks[a], s && "get"in s && (r = s.get(e, !0, n)), void 0 === r && (r = w(e, t, i)), "normal" === r && t in Je && (r = Je[t]), "" === n || n ? (o = parseFloat(r), n === !0 || Z.isNumeric(o) ? o || 0 : r) : r
        }
        ...
        css: function (e, t) {
            return me(this, function (e, t, n) {
                var i, r, o = {}, s = 0;
                if (Z.isArray(t)) {
                    for (i = $e(e), r = t.length; r > s; s++)o[t[s]] = Z.css(e, t[s], !1, i);
                    return o
                }
    ...
    var Ge, Qe, Ke = /^(?:toggle|show|hide)$/, Ze = new RegExp("^(?:([+-])=|)(" + we + ")([a-z%]*)$", "i"), et = /queueHooks$/, tt = [O], nt = {
        "*": [function (e, t) {
            var n = this.createTween(e, t), i = n.cur(), r = Ze.exec(t), o = r && r[3] || (Z.cssNumber[e] ? "" : "px"), s = (Z.cssNumber[e] || "px" !== o && +i) && Ze.exec(Z.css(n.elem, e)), a = 1, u = 20;
            if (s && s[3] !== o) {
                o = o || s[3], r = r || [], s = +i || 1;
    ...
    Z.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            return e && 3 !== o && 8 !== o && 2 !== o ? typeof e.getAttribute === ke ? Z.prop(e, t, n) : (1 === o && Z.isXMLDoc(e) || (t = t.toLowerCase(), i = Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? rt : it)), void 0 === n ? i && "get"in i && null !== (r = i.get(e, t)) ? r : (r = Z.find.attr(e, t), null == r ? void 0 : r) : null !== n ? i && "set"in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : void Z.removeAttr(e, t)) : void 0
    ...
    Z.fn.extend({
        addClass: function (e) {
            ...
            if (a)for (t = (e || "").match(fe) || []; l > u; u++)if (n = this[u], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(at, " ") : " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(Z.isFunction(e) ? function (n) {
                ...
                if ("string" === n)for (var t, i = 0, r = Z(this), o = e.match(fe) || []; t = o[i++];)r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else(n === ke || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : ve.get(this, "__className__") || "")
            })
        }, hasClass: function (e) {
    ...
    var dt = /#.*$/, pt = /([?&])_=[^&]*/, ft = /^(.*?):[ \t]*([^\r\n]*)$/gm, ht = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, gt = /^(?:GET|HEAD)$/, mt = /^\/\//, vt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, yt = {}, bt = {}, xt = "*/".concat("*"), wt = e.location.href, Tt = vt.exec(wt.toLowerCase()) || [];
    Z.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function (e, t) {
            function n(e, t, n, s) {
                var u, c, v, y, x, T = t;
                2 !== b && (b = 2, a && clearTimeout(a), i = void 0, o = s || "", w.readyState = e > 0 ? 4 : 0, u = e >= 200 && 300 > e || 304 === e, n && (y = R(d, w, n)), y = B(d, y, w, u), u ? (d.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (Z.lastModified[r] = x), x = w.getResponseHeader("etag"), x && (Z.etag[r] = x)), 204 === e || "HEAD" === d.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = y.state, c = y.data, v = y.error, u = !v)) : (v = T, (e || !T) && (T = "error", 0 > e && (e = 0))), w.status = e, w.statusText = (t || T) + "", u ? h.resolveWith(p, [c, T, w]) : h.rejectWith(p, [w, T, v]), w.statusCode(m), m = void 0, l && f.trigger(u ? "ajaxSuccess" : "ajaxError", [w, d, u ? c : v]), g.fireWith(p, [w, T]), l && (f.trigger("ajaxComplete", [w, d]), --Z.active || Z.event.trigger("ajaxStop")))
            }
            ...
            if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || wt) + "").replace(dt, "").replace(mt, Tt[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = Z.trim(d.dataType || "*").toLowerCase().match(fe) || [""], null == d.crossDomain && (u = vt.exec(d.url.toLowerCase()), d.crossDomain = !(!u || u[1] === Tt[1] && u[2] === Tt[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (Tt[3] || ("http:" === Tt[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = Z.param(d.data, d.traditional)), P(yt, d, t, w), 2 === b)return w;
            l = Z.event && d.global, l && 0 === Z.active++ && Z.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !gt.test(d.type), r = d.url, d.hasContent || (d.data && (r = d.url += (ct.test(r) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = pt.test(r) ? r.replace(pt, "$1_=" + lt++) : r + (ct.test(r) ? "&" : "?") + "_=" + lt++)), d.ifModified && (Z.lastModified[r] && w.setRequestHeader("If-Modified-Since", Z.lastModified[r]), Z.etag[r] && w.setRequestHeader("If-None-Match", Z.etag[r])), (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + xt + "; q=0.01" : "") : d.accepts["*"]);
    ...
    var jt = 0, Dt = {}, At = {0: 200, 1223: 204}, Lt = Z.ajaxSettings.xhr();
    e.attachEvent && e.attachEvent("onunload", function () {
        for (var e in Dt)Dt[e]()
    }), G.cors = !!Lt && "withCredentials"in Lt, G.ajax = Lt = !!Lt, Z.ajaxTransport(function (e) {
        var t;
        return G.cors || Lt && !e.crossDomain ? {
            send: function (n, i) {
                ...
                t = function (e) {
                    return function () {
                        t && (delete Dt[s], t = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? i(o.status, o.statusText) : i(At[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {text: o.responseText} : void 0, o.getAllResponseHeaders()))
                    }
    ...
    Z.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(qt, "$1" + r) : t.jsonp !== !1 && (t.url += (ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
    ...
    Z.offset = {
        setOffset: function (e, t, n) {
            ...
            "static" === c && (e.style.position = "relative"), a = d.offset(), o = Z.css(e, "top"), u = Z.css(e, "left"), l = ("absolute" === c || "fixed" === c) && (o + u).indexOf("auto") > -1, l ? (i = d.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(u) || 0), Z.isFunction(t) && (t = t.call(e, n, a)), null != t.top && (p.top = t.top - a.top + s), null != t.left && (p.left = t.left - a.left + r), "using"in t ? t.using.call(e, p) : d.css(p)
        }
    }, Z.fn.extend({
        offset: function (e) {
            ...
            return o ? (t = o.documentElement, Z.contains(t, i) ? (typeof i.getBoundingClientRect !== ke && (r = i.getBoundingClientRect()), n = W(o), {
        ...
        Z.cssHooks[t] = T(G.pixelPosition, function (e, n) {
            return n ? (n = w(e, t), ze.test(n) ? Z(e).position()[t] + "px" : n) : void 0
        })
    ...
    var Pt = e.jQuery, Ft = e.$;
    return Z.noConflict = function (t) {
        return e.$ === Z && (e.$ = Ft), t && e.jQuery === Z && (e.jQuery = Pt), Z
    ...
    1: [function (e, t, n) {
        function i(e, t) {
            ...
            n.open("GET", e, !0), n.onreadystatechange = function () {
                if (200 == n.status && 4 == n.readyState)try {
    ...
    2: [function (e, t, n) {
        ...
        function l(e) {
            for (var t = [], n = 0; n < e.length; n++)s(e[n]) && t.push(u(e[n]));
            return t
        }
        ...
        function d(t) {
            m = t || {}, m.fuzzy = t.fuzzy || !1, m.limit = t.limit || 10, m.searchStrategy = e(t.fuzzy ? "./SearchStrategies/FuzzySearchStrategy" : "./SearchStrategies/LiteralSearchStrategy")
        }
        ...
        function f(e, t, n, i) {
            for (var r in e)if (!h(e[r], i.exclude) && n.matches(e[r], t))return e
        }
        ...
        t.exports = {put: i, clear: r, get: o, search: c, setOptions: d};
        var g = [], m = {};
        m.fuzzy = !1, m.limit = 10, m.searchStrategy = e(m.fuzzy ? "./SearchStrategies/FuzzySearchStrategy" : "./SearchStrategies/LiteralSearchStrategy")
    }, {"./SearchStrategies/FuzzySearchStrategy": 3, "./SearchStrategies/LiteralSearchStrategy": 4}],
    3: [function (e, t, n) {
        function i() {
            function e(e) {
            ...
            this.matches = function (t, n) {
                return "string" != typeof t ? !1 : (t = t.trim(), !!e(n).test(t))
            }
        }
    ...
    4: [function (e, t, n) {
        function i() {
            this.matches = function (e, t) {
                return "string" != typeof e ? !1 : (e = e.trim(), e.toLowerCase().indexOf(t.toLowerCase()) >= 0)
            }
        }
    ...
    5: [function (e, t, n) {
        function i(e) {
            o = e || {}, o.templatePattern = e.templatePattern || /\{(.*?)\}/g
        }
        ...
        t.exports = {render: r, setOptions: i};
        var o = {};
        o.templatePattern = /\{(.*?)\}/g
    }, {}],
    6: [function (e, t, n) {
        !function (t, n, i) {
            ...
            function o(e) {
                g.load(e, function (t, n) {
                    t ? s("failed to get JSON (" + e + ")") : (h.put(n), d())
                })
            }
            ...
            function p(e) {
                if (l(), 0 == e.length)return c(v.noResultsText);
                for (var t = 0; t < e.length; t++)c(f.render(v.searchResultTemplate, e[t]))
            }

            var f = e("./Templater"), h = e("./Repository"), g = e("./JSONLoader"), m = ["searchInput", "resultsContainer", "json"], v = {
                searchInput: null,
            ...
            t.SimpleJekyllSearch = function (e) {
                v = a(e), h.setOptions(e), u(v.json) ? r(v.json) : o(v.json)
            }, t.SimpleJekyllSearch.init = t.SimpleJekyllSearch
        }(window, document)
    }, {"./JSONLoader": 1, "./Repository": 2, "./Templater": 5}]
}, {}, [6]), !function (e, t, n, i) {
    n.swipebox = function (r, o) {
        ...
        l.settings = {}, n.swipebox.close = function () {
            s.closeSlide()
        }, n.swipebox.extend = function () {
            return s
        }, l.init = function () {
            l.settings = n.extend({}, u, o), n.isArray(r) ? (c = r, s.target = n(e), s.init(l.settings.initialIndexOnArray)) : n(t).on("click", d, function (e) {
                if ("slide current" === e.target.parentNode.className)return !1;
                n.isArray(r) || (s.destroy(), a = n(d), s.actions()), c = [];
                var t, i, o;
                o || (i = "data-rel", o = n(this).attr(i)), o || (i = "rel", o = n(this).attr(i)), a = o && "" !== o && "nofollow" !== o ? p.filter("[" + i + '="' + o + '"]') : n(d), a.each(function () {
                    var e = null, t = null;
                    n(this).attr("title") && (e = n(this).attr("title")), n(this).attr("href") && (t = n(this).attr("href")), c.push({
                        href: t,
                        title: e
                    })
                }), t = a.index(n(this)), e.preventDefault(), e.stopPropagation(), s.target = n(e.target), s.init(t)
            })
        }, s = {
            init: function (e) {
                l.settings.beforeOpen && l.settings.beforeOpen(), this.target.trigger("swipebox-start"), n.swipebox.isOpen = !0, this.build(), this.openSlide(e), this.openMedia(e), this.preloadMedia(e + 1), this.preloadMedia(e - 1), l.settings.afterOpen && l.settings.afterOpen()
            }, build: function () {
                var e, t = this;
                n("body").append(b), g && l.settings.useSVG === !0 && (e = n("#swipebox-close").css("background-image"), e = e.replace("png", "svg"), n("#swipebox-prev, #swipebox-next, #swipebox-close").css({"background-image": e})), f && l.settings.removeBarsOnMobile && n("#swipebox-bottom-bar, #swipebox-top-bar").remove(), n.each(c, function () {
                ...
                "onorientationchange"in e ? e.addEventListener("orientationchange", function () {
                    0 === e.orientation ? (t = m, i = v) : (90 === e.orientation || -90 === e.orientation) && (t = v, i = m)
                ...
                g.addClass("visible-bars"), a.setTimeout(), n("body").bind("touchstart", function (a) {
                    return n(this).addClass("touching"), e = n("#swipebox-slider .slide").index(n("#swipebox-slider .slide.current")), h = a.originalEvent.targetTouches[0], f.pageX = a.originalEvent.targetTouches[0].pageX, f.pageY = a.originalEvent.targetTouches[0].pageY, n("#swipebox-slider").css({
                        "-webkit-transform": "translate3d(" + y + "%, 0, 0)",
                        transform: "translate3d(" + y + "%, 0, 0)"
                    }), n(".touching").bind("touchmove", function (a) {
                        if (a.preventDefault(), a.stopPropagation(), h = a.originalEvent.targetTouches[0], !l && (o = i, i = h.pageY - f.pageY, Math.abs(i) >= p || u)) {
                            var g = .75 - Math.abs(i) / v.height();
                            v.css({top: i + "px"}), v.css({opacity: g}), u = !0
                        }
                        r = t, t = h.pageX - f.pageX, s = 100 * t / m, !l && !u && Math.abs(t) >= d && (n("#swipebox-slider").css({
                            "-webkit-transition": "",
                            transition: ""
                        }), l = !0), l && (t > 0 ? 0 === e ? n("#swipebox-overlay").addClass("leftSpringTouch") : (n("#swipebox-overlay").removeClass("leftSpringTouch").removeClass("rightSpringTouch"), n("#swipebox-slider").css({
                            "-webkit-transform": "translate3d(" + (y + s) + "%, 0, 0)",
                            transform: "translate3d(" + (y + s) + "%, 0, 0)"
                        })) : 0 > t && (c.length === e + 1 ? n("#swipebox-overlay").addClass("rightSpringTouch") : (n("#swipebox-overlay").removeClass("leftSpringTouch").removeClass("rightSpringTouch"), n("#swipebox-slider").css({
                            "-webkit-transform": "translate3d(" + (y + s) + "%, 0, 0)",
                            transform: "translate3d(" + (y + s) + "%, 0, 0)"
                        }))))
                    }), !1
                    ...
                    if (e.preventDefault(), e.stopPropagation(), n("#swipebox-slider").css({
                        ...
                        }), i = h.pageY - f.pageY, t = h.pageX - f.pageX, s = 100 * t / m, u)if (u = !1, Math.abs(i) >= 2 * p && Math.abs(i) > Math.abs(o)) {
                        var c = i > 0 ? v.height() : -v.height();
                        v.animate({top: c + "px", opacity: 0}, 300, function () {
                            a.closeSlide()
                        })
                    } else v.animate({
                        top: 0,
                        opacity: 1
                    }, 300); else l ? (l = !1, t >= d && t >= r ? a.getPrev() : -d >= t && r >= t && a.getNext()) : g.hasClass("visible-bars") ? (a.clearTimeout(), a.hideBars()) : (a.showBars(), a.setTimeout());
                ...
                this.doCssTrans() ? e.addClass("visible-bars") : (n("#swipebox-top-bar").animate({top: 0}, 500), n("#swipebox-bottom-bar").animate({bottom: 0}, 500), setTimeout(function () {
                    e.addClass("visible-bars")
                }, 1e3))
            }, hideBars: function () {
                var e = n("#swipebox-top-bar, #swipebox-bottom-bar");
                this.doCssTrans() ? e.removeClass("visible-bars") : (n("#swipebox-top-bar").animate({top: "-50px"}, 500), n("#swipebox-bottom-bar").animate({bottom: "-50px"}, 500), setTimeout(function () {
                    e.removeClass("visible-bars")
                }, 1e3))
            }, animBars: function () {
                var e = this, t = n("#swipebox-top-bar, #swipebox-bottom-bar");
                ...
                c.length < 2 ? (n("#swipebox-bottom-bar").hide(), i === c[1] && n("#swipebox-top-bar").hide()) : (n("#swipebox-prev").bind(t, function (t) {
                ...
                }) : i.animate({left: 100 * -e + "%"}), n("#swipebox-slider .slide").removeClass("current"), n("#swipebox-slider .slide").eq(e).addClass("current"), this.setTitle(e), t && i.fadeIn(), n("#swipebox-prev, #swipebox-next").removeClass("disabled"), 0 === e ? n("#swipebox-prev").addClass("disabled") : e === c.length - 1 && l.settings.loopAtEnd !== !0 && n("#swipebox-next").addClass("disabled")
            }, openSlide: function (t) {
                n("html").addClass("swipebox-html"), h ? (n("html").addClass("swipebox-touch"), l.settings.hideCloseButtonOnMobile && n("html").addClass("swipebox-no-close-button")) : n("html").addClass("swipebox-no-touch"), n(e).trigger("resize"), this.setSlide(t, !0)
                ...
                var t, r, o = this;
                return c[e] !== i && (t = c[e].href), 0 > e || e >= c.length ? !1 : (r = n("#swipebox-slider .slide").eq(e), void(o.isVideo(t) ? r.html(o.getVideo(t)) : (r.addClass("slide-loading"), o.loadMedia(t, function () {
                    r.removeClass("slide-loading"), r.html(this)
                }))))
            }, setTitle: function (e) {
                var t = null;
                n("#swipebox-title").empty(), c[e] !== i && (t = c[e].title), t ? (n("#swipebox-top-bar").show(), n("#swipebox-title").append(t)) : n("#swipebox-top-bar").hide()
            }, isVideo: function (e) {
                if (e) {
                ...
                var r = t.createElement("a"), o = {};
                return r.href = decodeURIComponent(e), r.search && (o = JSON.parse('{"' + r.search.toLowerCase().replace("?", "").replace(/&/g, '","').replace(/=/g, '":"') + '"}')), n.isPlainObject(i) && (o = n.extend(o, i, l.settings.queryStringData)), n.map(o, function (e, t) {
                    return e && e > "" ? encodeURIComponent(t) + "=" + encodeURIComponent(e) : void 0
                }).join("&")
            }, getVideo: function (e) {
                var t = "", n = e.match(/((?:www\.)?youtube\.com|(?:www\.)?youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/), i = e.match(/(?:www\.)?youtu\.be\/([a-zA-Z0-9\-_]+)/), r = e.match(/(?:www\.)?vimeo\.com\/([0-9]*)/), o = "";
                return n || i ? (i && (n = i), o = s.parseUri(e, {
                ...
                if (0 === e.trim().indexOf("#"))t.call(n("<div>", {"class": "swipebox-inline-container"}).append(n(e).clone().toggleClass(l.settings.toggleClassOnLoad))); else if (!this.isVideo(e)) {
                ...
                i + 1 < c.length ? (e = n("#swipebox-slider .slide").eq(i).contents().find("iframe").attr("src"), n("#swipebox-slider .slide").eq(i).contents().find("iframe").attr("src", e), i++, t.setSlide(i), t.preloadMedia(i + 1), l.settings.nextSlide && l.settings.nextSlide()) : l.settings.loopAtEnd === !0 ? (e = n("#swipebox-slider .slide").eq(i).contents().find("iframe").attr("src"), n("#swipebox-slider .slide").eq(i).contents().find("iframe").attr("src", e), i = 0, t.preloadMedia(i), t.setSlide(i), t.preloadMedia(i + 1), l.settings.nextSlide && l.settings.nextSlide()) : (n("#swipebox-overlay").addClass("rightSpring"), setTimeout(function () {
                    n("#swipebox-overlay").removeClass("rightSpring")
                }, 500))
            }, getPrev: function () {
                var e, t = n("#swipebox-slider .slide").index(n("#swipebox-slider .slide.current"));
                t > 0 ? (e = n("#swipebox-slider .slide").eq(t).contents().find("iframe").attr("src"), n("#swipebox-slider .slide").eq(t).contents().find("iframe").attr("src", e), t--, this.setSlide(t), this.preloadMedia(t - 1), l.settings.prevSlide && l.settings.prevSlide()) : (n("#swipebox-overlay").addClass("leftSpring"), setTimeout(function () {
                ...
                n(e).unbind("keyup"), n("body").unbind("touchstart"), n("body").unbind("touchmove"), n("body").unbind("touchend"), n("#swipebox-slider").unbind(), n("#swipebox-overlay").remove(), n.isArray(r) || r.removeData("_swipebox"), this.target && this.target.trigger("swipebox-destroy"), n.swipebox.isOpen = !1, l.settings.afterClose && l.settings.afterClose()
            }
        }, l.init()
    ...
    function n(e, n) {
        this.el = e, this.options = t({}, this.options), t(this.options, n), this.ctrlClose = this.el.querySelector("[data-modal-close]"), this.isOpen = !1, this._initEvents()
    }
    ...
    }, o = r[Modernizr.prefixed("animation")], s = function (e, t) {
        var n = function (e) {
            if (i.animations) {
    ...
    n.prototype.options = {
        ...
        var e = this;
        this.isOpen ? (classie.remove(document.body, "modal--open"), classie.remove(this.el, "modal--open"), classie.add(e.el, "modal--close"), s(this.el.querySelector(".modal__content"), function () {
            classie.remove(e.el, "modal--close")
        }), this.options.onCloseModal(this)) : (classie.add(document.body, "modal--open"), classie.add(this.el, "modal--open"), document.getElementById("search-input").focus(), this.options.onOpenModal(this)), this.isOpen = !this.isOpen
    }, e.ModalFx = n
}(window);
var ModalFx = ModalFx || [];
!function () {
    var e = document.querySelector("[data-modal]"), t = document.getElementById(e.getAttribute("data-modal")), n = new ModalFx(t);
...
SimpleJekyllSearch({
    ...
    var n = e(".main-header"), i = e(".scroll-up");
    e(document).ready(function () {
        e(".swipebox").swipebox(), i.scrolltoo()
    }), e(window).scroll(function () {
        var t = n.height();
        e(this).scrollTop() > t ? i.css({bottom: "15px"}) : i.css({bottom: "-80px"})
    }), e.fn.scrolltoo = function (t) {
        var n = {elem: e(this), speed: 800}, i = e.extend(n, t);
        i.elem.click(function (t) {
            ...
            s ? (n = parseInt(s, 10), o.stop(!0, !1).animate({scrollTop: e(this.hash).offset().top + n}, i.speed)) : a ? (n = parseInt(a, 10), o.stop(!0, !1).animate({scrollTop: n}, i.speed)) : o.stop(!0, !1).animate({scrollTop: e(this.hash).offset().top}, i.speed)
        })
    }
}(jQuery);